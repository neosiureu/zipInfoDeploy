...
export default function MyStock() {
  ...
  const getMessageContent = async () => {
    try {
      const response = await axiosAPI.post('/myPage/getMessageContent', {messageNo});
  ...
  const getInquiredMessage = async () => {
    try {
      const response = await axiosAPI.post('/myPage/getInquiredMessage', {messageNo});
  ...
  const getMessageFile = async () => {
    try {
      const response = await axiosAPI.post('/myPage/getMessageFile', {messageNo});
    ...
    <div className="my-page-my-stock">
      ...
      <div className="my-detail-message-contact-form">
        <div className="my-detail-message-form-section">
            ...
            <div
              className="my-detail-message-title"
            >{message.messageTitle}</div>
        </div>

          <div className="my-detail-message-content">
            <div className="my-detail-message-content-area">
              <div
                className="my-detail-message-form-textarea"
                ...
                >
                  {messageFile && messageFile.fileOriginName ? (
                    <>
                      ...
                      <a href={messageFile.fileUrl} download={messageFile.fileOriginName}>
      ...
      <div>
        ...
        <button onClick={()=> nav("/myPage/seeMyMessage")} className="my-message-submit-button">
          목록으로
        </button>
      </div>
    </div>
