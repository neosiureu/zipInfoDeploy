...
public class FileConfig implements WebMvcConfigurer {
	...
	@Value("${my.sale.resource-handler}")
	private String resourceSaleHandler;

	@Value("${my.sale.resource-location}")
	private String resourceSaleLocation;
...
//		.addResourceLocations("file:///C:/uploadSemiFiles/test/");
		...
		registry.addResourceHandler(resourceStockHandler) // /myPage/stock/**
				.addResourceLocations(resourceStockLocation); // file:///C:/uploadFiles/stock/

		registry.addResourceHandler(resourceBoardHandler) // /images/boardImg/**
				.addResourceLocations(resourceBoardLocation); // file:///C:/uploadFiles/boardImg/

		registry.addResourceHandler(resourceMessageHandler).addResourceLocations(resourceMessageLocation);

		registry.addResourceHandler(resourceAnnounceHandler).addResourceLocations(resourceAnnounceLocation);

		registry.addResourceHandler(resourceAdvertiseHandler).addResourceLocations(resourceAdvertiseLocation);

		registry.addResourceHandler(resourceSaleHandler).addResourceLocations(resourceSaleLocation);
